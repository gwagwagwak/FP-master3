        ...
        <section class="tile_container">
            ...
            <div class="vx_tile_secondary withdrawReview-panel test_transfer-list-container">
                <div class="vx_tile-content">
                    <a href="registCardForm.do" data-name="addCard" class="interstitial-entryLink test_addNewCard" pa-marked="1">
                    ...
                    <div class="fiDetails-balance_info">
                        ...
                        <div style="display:flex;justify-content:center">
                            ...
                            <table style="width:300px;">
                                ...
                                <tr><td>이름</td><td>${card.getC_type()}</td></tr>
                                <tr><td>만료일</td><td>${card.getC_expr()}</td></tr>
                                <tr><td>청구 주소  </td><td>${card.getC_addr()}</td></tr>
...
function removeCheck() {
	 ...
	 if (confirm("확인을 누르시면 완전히 삭제됩니다. 정말 삭제하시겠습니까?") == true){    //확인

		 window.location.href ='deleteCard.do?c_number='+${card.getC_number()};
