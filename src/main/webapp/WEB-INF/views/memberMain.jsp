...
<script
	...
	defer=""></script>
<script src="//www.paypalobjects.com/gajs/analytics.js"
...
<script type="text/javascript" async="" crossorigin="anonymous"
	src="https://www.paypalobjects.com/tagmgmt/codefiles/fb528686d3331551e73710d4418a1205.js?conditionId0=3241080"></script>
...
<link rel="stylesheet"
	href="https://www.paypalobjects.com/web/res/66d/fe6685ae836fb58960839a98f2101/css/main.css">
		...
		<div class="col-sm-12 noGutter">
			<div class="row">
				<div id="A" class="col-sm-7">
					...
					<span class="vx_text-2_regular welcome-container">안녕하세요?
						${member.m_lname}${member.m_fname} 님,</span>
					<!-- ${loginMember.m_fname} -->
					<span class="vx_text-6_regular welcome-container">금액보내기, 사용,
						결제받기 등을 설정하는 것을 도와드립니다.</span>
						...
						<div>
							<div data-widget-name="balance" class="cw_tile-container"
								...
								<h3 class="cw_tile-header">
									<a data-name="balanceHeader" class="cw_tile-headerLink"
										href="/myaccount/wallet/balance">PayPal 잔액</a>
								</h3>
								...
								<div>
									<p class="vx_text-2_regular cw_tile-zeroState"
										style="text-align: right">0 원</p>
								</div>
							</div>
						</div>
						<div>
							<div data-widget-name="activity" class="cw_tile-container"
								style="background: lightblue">
								<h3 class="cw_tile-header">
									<a data-name="activityHeader" class="cw_tile-headerLink"
										href="/myaccount/transactions">최근 활동내역 <span
										class="ppvx_icon ppvx_icon--size_sm ppvx_icon-arrow-left cw_tile__activity-overflowMenuIcon"></span>
									</a>
								</h3>
											...
											<div aria-hidden="true" class="ppvx_container-fluid">
												<span
													...
													<p
														...
														dir="ltr">
														<span
															class="ppvx_text--md cw_tile__activity-txnAmount  test_activity-txnAmount">-$54.89</span>
													</p>
												</span>
											</div>
											<p class="vx_a11yText">7월 22, JetBrains s.r.o.,
												undefined, 자동 결제, -$54.89</p>
									</a>
									</li>
									<li
										class="cw_tile-itemListContainer cw_tile-itemListContainer_hover  ">
										<a data-name="activityRowItem"
										href="/myaccount/transactions/details/5W0487860A397412E"
										class="cw_tile-itemListLink">
											<div aria-hidden="true" class="ppvx_container-fluid">
												<span
													class="ppvx_row cw_tile-itemListRow cw_tile-activityListRow">
								...
								<a data-name="activityButton"
									...
									href="#">고객센터</a> <a data-name="activityButton"
									class="ppvx_btn ppvx_btn--secondary ppvx_btn--size_sm cw_tile__activity-moreButton"
									href="#">회사소개</a>
				...
				<div id="B" class="col-sm-5 rightSide-container">
					<h2 class="vx_a11yText">도구</h2>
					<div>
					...
					<%--오른쪽 div 시작점--%>
					<div>
						<div data-widget-name="accountquality_secondary"
							class="cw_tile-container">
							<br>
							<h2 class="ppvx_text--md ppvx_text--medium">
								<a href="#">내가 쓴 글</a>
							</h2>
					...
					<div>
						<div data-widget-name="bankcard" class="cw_tile-container">
							<h3 class="cw_tile-header">
								<a data-name="bankcardHeader" class="cw_tile-headerLink"
									href="actionCardAfter.do">은행 및 카드</a>
							</h3>
							<div class="cw_overflowMenu-container">
								<button data-name="overflowMenu"
									class="cw_overflowMenu-trigger test_cwOverflowMenu-trigger"
									aria-label="Menu Options"
									aria-describedby="cw_overflowMenu-descriptor">
									<span
										class="vx_icon vx_icon-medium vx_icon-slider-small cw_overflowMenu-icon"></span>
								</button>
								<div class="cw_overflowMenu-menu">
									<ul class="cw_overflowMenu-list">
										<li tabindex="-1"><a class="cw_overflowMenu-item "
											href="actionCardAfter.do" data-name="overflowWallet"
										...
										<li tabindex="-1"><a class="cw_overflowMenu-item "
											...
											aria-describedby="cw_overflowMenu-itemDescriptor">지원 받기</a></li>
									</ul>
									<span id="cw_overflowMenu-descriptor" class="cw_a11yText">Menu
										containing additional options</span> <span
										id="cw_overflowMenu-itemDescriptor" class="cw_a11yText">Sub-item
										of Menu Options. Hit the escape key to close this menu.</span>
								</div>
							</div>
							
							<ul class="cw_tile-itemList">
							<c:forEach var="clist" items="${clist}" begin="0" end="2">
								<li class="cw_tile-itemListContainer  cw_tile__bankcard-cardRowItem">
									<a data-name="cardRowItem" href="getCard.do?c_number=${clist.getC_number() }" class="cw_tile-itemListLink"> <span
										class="cw_tile-itemListRow table-row"> <span
											class=" table-col-xs cw_tile-itemListCol cw_tile-itemListIcon">
												<span class="cw_icon-rectangleLogo_small cw_shadow"
												style="background-image: url(https://www.paypalobjects.com/ui-web/money-icons/card/master_card.png); background-size: cover"></span>
										</span> <span class="table-col-xs cw_tile-itemListCol"><span
												class="ppvx_text--md cw_tile-itemListHeader">${clist.getC_type() }</span>
												<span class="ppvx_text--sm">출금 ${clist.getC_number() }</span></span></span></a>
								</li>
								</c:forEach>
							</ul>
							<a data-name="LinkBankOrCard" href="registCardForm.do"
								id="bankCardLinkBankOrCard" role="button"
								class="ppvx_btn ppvx_btn--secondary ppvx_btn--size_sm cw_tile-button">카드
								또는 은행 연결</a>
						</div>
					</div>
					<div></div>
				...
				<div>
					<div>
						<div data-widget-name="floatingPromo"
							class="cw_tile__floatingPromo-container">
							<div
								style="display: flex; flex-flow: row; justify-content: flex-end">
